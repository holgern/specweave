...
Feature: Gherkin feature file parsing
  ...
  The Gherkin parser reads classic feature text and produces
  Feature/Rule/Scenario/Step dataclass instances.
  ...
  Rule: Parser dispatches by format
    ...
    @bdd-parser-rejects-markdown-path
    Example: Parser rejects .feature.md files
      Given a feature source with ".feature.md" suffix
      When specweave parses the feature
      Then parsing fails with a migration message
