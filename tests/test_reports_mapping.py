...
# sw: f=specs/behavior/features/reports/mapping.feature
# sw: s=@bdd-tag-extraction-bdd
...
# sw: f=specs/behavior/features/reports/mapping.feature
# sw: s=@bdd-criteria-missing-coverage
